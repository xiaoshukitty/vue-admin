<template>
    <div class="waterfallFlow">
        <vue-waterfall-easy :imgsArr="imgsArr" @scrollReachBottom="handleReachBottom" :img-width="300" cardClass="cardStyle"
            @click="handleClick">
...
/**
 * 
 * github链接   https://github.com/parrot-design/parrot-ve-waterfall
 */
